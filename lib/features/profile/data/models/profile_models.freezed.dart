...
class _$ProfileUpdateRequestImpl implements _ProfileUpdateRequest {
  ...
  @override
  String toString() {
    return 'ProfileUpdateRequest(username: $username, firstName: $firstName, lastName: $lastName, avatarUrl: $avatarUrl)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, username, firstName, lastName, avatarUrl);
...
class _$UserResponseImpl implements _UserResponse {
  ...
  @override
  String toString() {
    return 'UserResponse(id: $id, email: $email, username: $username, firstName: $firstName, lastName: $lastName, displayName: $displayName, avatarUrl: $avatarUrl, isVerified: $isVerified, isGoldMember: $isGoldMember, profileCompleted: $profileCompleted)';
  }
...
abstract class _UserResponse implements UserResponse {
  const factory _UserResponse({
    ...
    required final bool isGoldMember,
