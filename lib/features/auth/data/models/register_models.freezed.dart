...
abstract class $RegisterResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({String message, String email, String nextStep});
}
...
class _$RegisterResponseImpl implements _RegisterResponse {
  ...
  @override
  String toString() {
    return 'RegisterResponse(message: $message, email: $email, nextStep: $nextStep)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, message, email, nextStep);
